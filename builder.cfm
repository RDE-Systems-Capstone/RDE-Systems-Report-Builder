...
<cfquery name="observations_list" datasource="MEDICALDATA"> 
    SELECT DISTINCT DESCRIPTION, CODE FROM observations
</cfquery>
	  ...
	  <h1>Report Builder</h1>
		<div class="form-group" style="width: 50%">
			...
			<select class="form-control" id="exampleFormControlSelect1">
			  <option>Trend Graph</option>
			  <option>Pie/Doughnut Chart</option>
		...
		<div class="filter_drop well">
			<p>Drag and drop filters here to add them.</p>
				<div hidden id="age_filter">
					...
					<input type="number" name="age_min" min="0" max="120" step="1" value="20">
					<label for="age_max">and</label>
					<input type="number" name="age_max" min="0" max="120" step="1" value="50">
				</div>
				<div hidden id="gender_filter">
					<h2>Gender filter</h2>
					<input type="checkbox" name="gender" value="M"> Male<br>
					<input type="checkbox" name="gender" value="F"> Female<br>
				</div>
				...
				<div hidden id="ethnicity_filter">
					...
					<cfloop query="#ethnicity_list#">
						<cfoutput>
							<input type="checkbox" name="ethnicity" value="#ETHNICITY#"> #ETHNICITY#
						</cfoutput>
					</cfloop>
				</div>
				...
				<!-- must add conditions, observations and other necessary filters -->
				
			</div>
		
		<h1>Output</h1>
		<div class="form-group" style="width: 50%">
			<label for="exampleFormControlSelect1">Select field to graph over time</label>
			<select class="form-control" id="exampleFormControlSelect1">
				<!--ColdFusion code to get list of observations + code number-->
